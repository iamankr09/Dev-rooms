                    ...
                    <div className="row animated zoomIn">
                        <div className="col">
                            <p className="h3 text-teal">
                                <i className="fa fa-user-shield">Registration</i>
                            </p>
                        ...
                        <div className="col-md-8">
                            <form onSubmit={submitRegistration}>
                                <div className="form-group">
                                    <input required name="name" value={user.name} onChange={validateUsername} type="text" className={`form-control mb-3 ${userError.nameError.length ? "isInvalid" : ""}`} placeholder='Name' />
                                ...
                                <div className="form-group">
                                    <input required name="email" value={user.email} onChange={validateEmail} type="email" className={`form-control mb-3 ${userError.emailError.length > 0 ? "is-invalid" : ""}`} placeholder='Email' />
