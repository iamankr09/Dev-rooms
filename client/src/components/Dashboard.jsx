            ...
            <React.Fragment>
              <section>
                <div className="container">
                  <div className="row">
                    <div className="col">
                      <Link to="/profiles/edit-profile" className="btn btn-info text-white btn-sm me-2">
                        <i className="fa fa-user-cog"> Edit Profile</i>
                      </Link>
                      <Link to="/profiles/add-experience" className='btn btn-success text-white btn-sm me-2'>
                    ...
                    <div className="row">
                      <div className="col">
                        <div className="table-responsive">
                          <table className="table table-bordered table-hover text-center table-light table-stripped">
                            <thead className="thread-dark text-secondary">
                              <tr>
                                <th>Title</th>
                                <th>Company</th>
                                <th>Location</th>
                ...
                {profile.education.length > 0 && (
                  <div className="container">
                    ...
                    <div className="row">
                      <div className="col">
                        <div className="table-responsive">
                          <table className="table table-hover table-bordered text-center table-light table-stripped">
                            <thead className="thread-dark text-teal">
                              <tr>
                                <th>School</th>
                                <th>Degree</th>
            ...
            <React.Fragment>
              <section>
                <div className="container">
                  <div className="row">
                    <div className="col">
                      <small>You don't have a profile yet! , please create one.</small>
                      <br />
                      <Link to="/profiles/create-profile" className="btn btn-secondary text-white btn-sm">
                        <i className="fa fa-user-cog"> Create Profile</i>
                      </Link>
                    </div>
                  </div>
                </div>
